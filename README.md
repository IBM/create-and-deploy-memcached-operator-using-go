...
implements the [Object interface]([Object interface](https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/client#Object)) (which means it is a kubernetes object), and also,
